...
const WorkingWay = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <button className="flex mx-auto mt-20 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">View Details</button>
  </div>
</section>
    );
};
